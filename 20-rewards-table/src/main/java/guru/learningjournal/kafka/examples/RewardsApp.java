...
public class RewardsApp {
    ...
    public static void main(String[] args) {
        ...
        .map((key, invoice) -> new KeyValue<>(invoice.getCustomerCardNo(), Notifications.getNotificationFrom(invoice))); // usando o map, pois vou mudar
        // apenas uma propriedade do objeto e nao o objeto como mapvalues.
